...
# AI router
from app.presentation.api.v1.endpoints import ai
api_router.include_router(ai.router, prefix="/ai", tags=["ai"])
api_router.include_router(admin_router, prefix="/admin", tags=["admin"])

# Farming Log & Traceability routers
from app.presentation.api.v1 import farming_log_api, traceability_api
api_router.include_router(farming_log_api.router, prefix="/farming", tags=["farming-log"])
api_router.include_router(traceability_api.router, prefix="/traceability", tags=["traceability"])
