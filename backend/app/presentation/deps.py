...
def get_farming_log_repository(db: AsyncSession = Depends(get_db)) -> SQLAlchemyFarmingLogRepository:
    """Dependency to get farming log repository."""
    return SQLAlchemyFarmingLogRepository(db)
